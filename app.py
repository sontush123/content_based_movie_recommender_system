...
if col2.button('CODE OF THIS PROJECT'):
    #open_github_repo()
    st.markdown('<a href="https://github.com/sontush123/content_based_movie_recommender_system.git" target="_blank">Click here to visit code reposistory of this Website</a>', unsafe_allow_html=True)
